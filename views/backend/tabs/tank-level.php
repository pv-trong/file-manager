<div class="flex flex-wrap lg:flex-nowrap gap-4 lg:divide-x mb-3">
    <div class="flex-1">
        <form action="" id="form-filter-tank-level">
    ...
    <div class="lg:pl-3 w-full lg:w-auto">
        <a href="<?= url('backend/tank-level/create') ?>" class="btn btn-solid inline-block">
            <span class="flex items-center justify-center gap-2">
                <span class="text-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="w-6 h-6">
...
<table id="tank-level-data-table" class="table-default table-hover data-table w-[auto]">
    <thead>
        <tr>
            <th>#</th>
            <th>Premium 95</th>

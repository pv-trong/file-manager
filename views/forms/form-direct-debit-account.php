<div class="card !border-0 card-border mb-3">
    <div class="card-body card-gutterless p-4">
        <form class="needs-validation" method="POST" action="<?= url('backend/dd-account/store')  ?>">
                ...
                <div class="grid grid-cols-1 divide-y" id="list-record">
                    <div class="flex py-3">
                        ...
                        <div class="form-item horizontal flex-1">
                            ...
                            <div class="w-full flex flex-col justify-center relative">
                                <span class="input-wrapper">
                                    <input name="data[0][amount]" class="input form-control pr-8" type="number" placeholder="Enter wet stock value" value="" required>
                                </span>
                            </div>
                        </div>
                    </div>

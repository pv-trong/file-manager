<div class="card !border-0 card-border mb-3">
    <div class="card-body card-gutterless p-4">
        <form class="needs-validation" method="POST" action="<?= isset($dataView) ? url('backend/loading/update/' . $dataView->id) : url('backend/loading/store') ?>">
            <div class="form-container vertical">
                ...
                <div class="form-item vertical">
                    <label class="form-label mb-2">Diesel Euro</label>
                    <span class="input-wrapper">
                        <input name="diesel_euro" class="input form-control pr-8" type="number" placeholder="Enter Diesel Euro 5" value="<?= @$dataView->diesel_euro ?>" required>
                    </span>
                </div>
                <div class="form-item vertical">

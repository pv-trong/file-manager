...
<section class="content-padding">
    <div class="container">
        ...
        <div class="row content-padding-sm align-items-center">
            <div class="col-lg-7"><img src="img/second.png"></div>
        ...
        <div class="row content-padding-sm align-items-center m-column-reverse">
            ...
            <div class="col-lg-1"></div>
            <div class="col-lg-7"><img src="img/3.png"></div>
        </div>
        <div class="row content-padding-sm align-items-center">
            <div class="col-lg-7"><img src="img/4.png"></div>
            <div class="col-lg-1"></div>
            <div class="col-lg-4">
                <div class="innerContent">
        ...
        <div class="row content-padding-sm align-items-center m-column-reverse">
            ...
            <div class="col-lg-1"></div>
            <div class="col-lg-7"><img src="img/5.png"></div>
        </div>
        <div class="row content-padding-sm align-items-center">
            <div class="col-lg-7"><img src="img/6.png"></div>
            <div class="col-lg-1"></div>
            <div class="col-lg-4">
                <div class="innerContent">
        ...
        <div class="row content-padding-sm align-items-center m-column-reverse">
            ...
            <div class="col-lg-1"></div>
            <div class="col-lg-7"><img src="img/7.png"></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="max-width">
            ...
            <form class="form" id="formID" method="POST">
                <input type="hidden" name="submit_confirm" value="yes">
                <div class="mb-3 row">
                    <div class="col-lg-4">
                        <input type="text" name="full_name" id="full_name" class="form-control" placeholder="ชื่อเต็ม">
                    </div>
                    <div class="col-lg-4">
                        <input type="text" name="telephone_number" id="telephone_number" class="form-control" placeholder="โทรศัพท์">
                    </div>
                    <div class="col-lg-4">
                        <input type="email" name="user_email_address" id="user_email_address" class="form-control" placeholder="อีเมล">
                    </div>
                </div>
                <div class="mb-3 row">
                    <div class="col-lg-12">
                        <textarea placeholder="ข้อความ" name="message_val" id="message_val" class="form-control"></textarea>
                    </div>
                </div>
                <div class="text-center">

window.addEventListener('load', () => {
    const recordHtml = `
                    <div class="flex py-3">
                        <div class="form-item horizontal flex-1">
                            ...
                            <div class="w-full flex flex-col justify-center relative">
                                <span class="input-wrapper">
                                    <input datepicker datepicker-orientation="bottom" name="data[__index__][date]" datepicker-format="dd/mm/yyyy" class="input pr-8" placeholder="Pick a date" readonly required>
                        ...
                        <div class="form-item horizontal flex-1">
                            ...
                            <div class="w-full flex flex-col justify-center relative">
                                <span class="input-wrapper">
                                    <input name="data[__index__][amount]" class="input form-control pr-8" type="number" placeholder="Enter amount value" value="">
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    $('#add-a-row').on('click', function () {
        ...
        $('#list-record').append(recordHtml.replaceAll('__index__', index + 1));
